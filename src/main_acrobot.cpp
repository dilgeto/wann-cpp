...
//
// Flags:
//   -v   Enable SNN debug log. Writes genome↔network comparisons for the best
//        individual every save_mod generations to log/<prefix>_debug.log.
...
int main(int argc, char* argv[]) {
    ...
    // Open debug log file if -v was passed (zero cost otherwise)
