...
//   ./wann_mountain_car_eval -w 1.5 -n 50   (fija el peso en lugar de buscarlo)
...
int main(int argc, char* argv[]) {
    ...
    if (weightArg == "best") {
        ...
        if (wif) {
            int wi; wif >> wi;
            chosenWeight = wann::SnnMountainCarTask::WEIGHT_VALS[wi];
            ...
            chosenWeight = wann::SnnMountainCarTask::WEIGHT_VALS[bestWi];
